...
const getSellPriceByFacilityServiceId = async (facilityServiceId) => {
  try {
    const response = await api.get(
      `/sell-price/get-sell-price-by-facility-service-id/${facilityServiceId}`
    );
    return response.data;
  } catch (error) {
...
const getSellPriceByTransportServiceId = async (transportDetailId) => {
  try {
    const response = await api.get(
      `/sell-price/get-sell-price-by-transport-service-id/${transportDetailId}`
    );
    return response.data;
  } catch (error) {
    console.error("Error fetching sell price:", error);
...
const getSellPriceByFacilityIdAndServiceType = async (
  facilityId,
  serviceTypeId,
  pageNumber,
  pageSize
  ...
  try {
    const response = await api.get(
      `/sell-price/get-sell-price-by-facility-Id-and-service-type/${facilityId}/${serviceTypeId}?pageNumber=${pageNumber}&pageSize=${pageSize}`
    );
    return response.data;
  } catch (error) {
    console.error("Error fetching sell price:", error);
...
const getMinMaxPriceOfHotel = async (
  districtId,
  privatetourRequestId,
  ratingId,
  pageNumber,
...
const getPriceOfVehicle = async (districtId, privatetourRequestId) => {
  try {
    const response = await api.get(
      `/sell-price/get-price-of-vehicle/${districtId}/${privatetourRequestId}`
    );
    return response.data;
  } catch (error) {
...
const getReferenceTransportByProvince = async (
  startPoint,
  endPoint,
  vehicleType,
  pageNumber,
  ...
  try {
    const response = await api.get(
      `/sell-price/get-reference-transport-by-province/${startPoint}/${endPoint}?vehicleType=${vehicleType}&pageNumber=${pageNumber}&pageSize=${pageSize}`
    );
    return response.data;
  } catch (error) {
...
const getAttractionSellPriceRange = async (
  districtId,
  privateTourRequestId,
  numOfPlace,
  pageNumber,
...
const getVehiclePriceRange = async (
  startPoint,
  endPoint,
  vehicleType,
  quantity,
...
export {
  ...
  getSellPriceByFacilityServiceId,
  getSellPriceByMenuId,
  getSellPriceByTransportServiceId,
  getSellPriceByFacilityIdAndServiceType,
